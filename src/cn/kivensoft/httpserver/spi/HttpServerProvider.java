...
package cn.kivensoft.httpserver.spi;
...
import cn.kivensoft.httpserver.inner.DefaultHttpServerProvider;

/**
 * Service provider class for HttpServer. Sub-classes of HttpServerProvider
 * provide an implementation of {@link HttpServer} and associated classes.
 * Applications do not normally use this class. See {@link #provider()} for how
 * providers are found and loaded.
 */
public abstract class HttpServerProvider {
	 ...
	 * 
	 * @param addr
	 *            the address to bind to. May be <code>null</code>
	 * @param backlog
	 *            the socket backlog. A value of <code>zero</code> means the
	 *            systems default
	 */
	 ...
	 * <li>
	 * <p>
	 * If the system property <tt>com.sun.net.httpserver.HttpServerProvider</tt>
	 ...
	 * fails then an unspecified unchecked error or exception is thrown.
	 * </p>
	 * </li>
	 *
	 * <li>
	 ...
	 * directory <tt>META-INF/services</tt>, then the first class name specified
	 * in that file is taken. The class is loaded and instantiated; if this
	 * process fails then an unspecified unchecked error or exception is thrown.
	 * </p>
	 * </li>
	 *
	 * <li>
