...
public class HttpsConfigurator {
	...
	/**
	 * Called by the HttpsServer to configure the parameters for a https
	 * connection currently being established. The implementation of configure()
	 * must call {@link HttpsParameters#setSSLParameters(SSLParameters)} in
	 * order to set the SSL parameters for the connection.
	 * <p>
